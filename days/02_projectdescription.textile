...
bq. $ merb-gen model --testing-framework rspec --orm datamapper question
    $ merb-gen model --testing-framework rspec --orm datamapper answer
    $ merb-gen model --testing-framework rspec --orm datamapper interest
    $ merb-gen model --testing-framework rspec --orm datamapper relevancy
